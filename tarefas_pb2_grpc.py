...
class TaskOrchestratorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SubmitTask = channel.unary_unary(
                ...
                request_serializer=tarefas__pb2.TaskRequest.SerializeToString,
                response_deserializer=tarefas__pb2.TaskResponse.FromString,
                _registered_method=True)
        self.CheckTaskStatus = channel.unary_unary(
                '/tarefas.TaskOrchestrator/CheckTaskStatus',
                request_serializer=tarefas__pb2.StatusRequest.SerializeToString,
                response_deserializer=tarefas__pb2.StatusResponse.FromString,
                _registered_method=True)
...
def add_TaskOrchestratorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SubmitTask': grpc.unary_unary_rpc_method_handler(
                    servicer.SubmitTask,
                    request_deserializer=tarefas__pb2.TaskRequest.FromString,
                    response_serializer=tarefas__pb2.TaskResponse.SerializeToString,
            ),
            'CheckTaskStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckTaskStatus,
                    request_deserializer=tarefas__pb2.StatusRequest.FromString,
                    response_serializer=tarefas__pb2.StatusResponse.SerializeToString,
            ),
    }
...
class TaskOrchestrator(object):
    ...
    def SubmitTask(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tarefas.TaskOrchestrator/SubmitTask',
            tarefas__pb2.TaskRequest.SerializeToString,
            tarefas__pb2.TaskResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def CheckTaskStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tarefas.TaskOrchestrator/CheckTaskStatus',
            tarefas__pb2.StatusRequest.SerializeToString,
            tarefas__pb2.StatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class WorkerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendHeartbeat = channel.unary_unary(
                ...
                request_serializer=tarefas__pb2.HeartbeatRequest.SerializeToString,
                response_deserializer=tarefas__pb2.HeartbeatResponse.FromString,
                _registered_method=True)
...
def add_WorkerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendHeartbeat': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tarefas__pb2.HeartbeatRequest.FromString,
                    response_serializer=tarefas__pb2.HeartbeatResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class WorkerService(object):
    ...
    def SendHeartbeat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tarefas.WorkerService/SendHeartbeat',
            tarefas__pb2.HeartbeatRequest.SerializeToString,
            tarefas__pb2.HeartbeatResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class SynchronizationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateState = channel.unary_unary(
                ...
                request_serializer=tarefas__pb2.StateUpdateRequest.SerializeToString,
                response_deserializer=tarefas__pb2.StateUpdateResponse.FromString,
                _registered_method=True)
...
def add_SynchronizationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UpdateState': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tarefas__pb2.StateUpdateRequest.FromString,
                    response_serializer=tarefas__pb2.StateUpdateResponse.SerializeToString,
            ),
...
class SynchronizationService(object):
    ...
    def UpdateState(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tarefas.SynchronizationService/UpdateState',
            tarefas__pb2.StateUpdateRequest.SerializeToString,
            tarefas__pb2.StateUpdateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class WorkerNodeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteTask = channel.unary_unary(
                ...
                request_serializer=tarefas__pb2.ExecuteTaskRequest.SerializeToString,
                response_deserializer=tarefas__pb2.ExecuteTaskResponse.FromString,
                _registered_method=True)
...
def add_WorkerNodeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExecuteTask': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tarefas__pb2.ExecuteTaskRequest.FromString,
                    response_serializer=tarefas__pb2.ExecuteTaskResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class WorkerNodeService(object):
    ...
    def ExecuteTask(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tarefas.WorkerNodeService/ExecuteTask',
            tarefas__pb2.ExecuteTaskRequest.SerializeToString,
            tarefas__pb2.ExecuteTaskResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
